<html>
	<head>
		...
		#header{
			...
			background-image: url(img/countries/azerbaijan.jpg) !important;
	...
	<body>
		...
		<div id="main">
			<div id="content">
				...
				<div class="colormain-"><h3>Азербайджан</h3></div>
				...
				<div class="map"><div>
					...
					</div><div><img src="img/clogos/azerbaijan.png"></div></div>
				
				<div class="flex countries">
					<div>
						<h1>Габала - <span>Chenot Palace Health Wellness Hotel</span></h1>
						<a href="gabala.php"><img src="img/clogos/logo-gabala.jpg"></a>
					</div>
				</div>
