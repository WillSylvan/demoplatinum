<html>
	<head>
		...
		#header{
			...
			background-image: url(img/countries/germany.jpg) !important;
	...
	<body>
		...
		<div id="main">
			<div id="content">
				...
				<div class="colormain-"><h3>Германия</h3></div>
				...
				<div class="map"><div>
					...
					</div><div><img src="img/clogos/germany.png"></div></div>
				
				<div class="flex countries">
					<div>
						<h1>Баден-Баден - <span>Brenners Park-Hotel & Spa</span></h1>
						<a href="baden-baden.php"><img src="img/clogos/logo-baden-baden.jpg"></a>
					</div>
				</div>
