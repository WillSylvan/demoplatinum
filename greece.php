<html>
	<head>
		...
		#header{
			...
			background-image: url(img/countries/greece.jpg) !important;
	...
	<body>
		...
		<div id="main">
			<div id="content">
				...
				<div class="colormain-"><h3>Греция</h3></div>
				...
				<div class="map"><div>
					...
					</div><div><img src="img/clogos/greece.png"></div></div>
				
				<div class="flex countries">
					<div>
						<h1>Элунда - <span>Relais & Châteaux Hotels</span></h1>
						<a href="el1.php"><img src="img/clogos/logo-elounda_mare.jpg"></a>
					</div>
					<div>
						<h1>Элунда - <span>elounda peninsula ALL SUITE HOTEL</span></h1>
						<a href="el2.php"><img src="img/clogos/logo-elounda_peninsula.jpg"></a>
					</div>
					<div>
						<h1>Элунда - <span>Porto Elounda GOLF & SPA RESORT</span></h1>
						<a href="el3.php"><img src="img/clogos/logo-elounda_porto.jpg"></a>
					</div>
				</div>
