<html>
	<head>
		...
		#header{
			...
			background-image: url(img/countries/spain.jpg) !important;
	...
	<body>
		...
		<div id="main">
			<div id="content">
				...
				<div class="colormain-"><h3>Испания</h3></div>
				...
				<div class="map"><div>
					...
					</div><div><img src="img/clogos/spain.png"></div></div>
				
				<div class="flex countries">
					<div>
						<h1>Сан-Фелиу-де-Гишольс - <span>Alàbriga Hotel & Home Suites</span></h1>
						<a href="san.php"><img src="img/clogos/logo-sanfeliu.jpg"></a>
					</div>
					<div>
						<h1>Эль-Абир - <span>SHA Wellness Clinic</span></h1>
						<a href="el.php"><img src="img/clogos/logo-alicante.jpg"></a>
					</div>
				</div>
