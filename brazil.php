<html>
	<head>
		...
		#header{
			...
			background-image: url(img/countries/brasil.jpg) !important;
	...
	<body>
		...
		<div id="main">
			<div id="content">
				...
				<div class="colormain-"><h3>Бразилия</h3></div>
				...
				<div class="map"><div>
					...
					</div><div><img src="img/clogos/brazil.png"></div></div>
				
				<div class="flex countries">
					<div>
						<h1>Сан-Паулу - <span>Palácio Tangará</span></h1>
						<a href="san-paulu.php"><img src="img/clogos/logo-palaciotangara.jpg"></a>
					</div>
				</div>
