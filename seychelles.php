<html>
	<head>
		...
		#header{
			...
			background-image: url(img/countries/seychelles.jpg) !important;
	...
	<body>
		...
		<div id="main">
			<div id="content">
				...
				<div class="colormain-"><h3>Сейшелы</h3></div>
				...
				<div class="map"><div>
					...
					</div><div><img src="img/clogos/seychelles.png"></div></div>
				
				<div class="flex countries">
					<div>
						<h1>o. Фрегат - <span>Fregate Island Private</span></h1>
						<a href="fregat.php"><img src="img/clogos/logo-fregat.jpg"></a>
					</div>
				</div>
