<html>
	<head>
		...
		#header{
			...
			background-image: url(img/countries/india.jpg) !important;
	...
	<body>
		...
		<div id="main">
			<div id="content">
				...
				<div class="colormain-"><h3>Индия</h3></div>
				...
				<div class="map"><div>
					...
					</div><div><img src="img/clogos/india.png"></div></div>
				
				<div class="flex countries">
					<div>
						<h1>Гималаи - <span>Ananda in the Himalayas</span></h1>
						<a href="himalai.php"><img src="img/clogos/logo-rishikesh.gif"></a>
					</div>
				</div>
