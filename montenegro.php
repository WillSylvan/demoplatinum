<html>
	<head>
    	...
    	<title>platinum travel</title><style>
		#header{
			height: 30vw !important;
			background-image: url(img/countries/montenegro.jpg) !important;
	...
	<body>
		...
		<div id="main">
			<div id="content">
				...
				<div class="colormain-"><h3>Черногория</h3></div>
				...
				<div class="map"><div>
					...
					</div><div><img src="img/clogos/montenegro.png"></div></div>
				
				<div class="flex countries">
					<div>
						<h1>Будва - <span>Dukley Hotel & Resort</span></h1>
						<a href="iniala.php"><img src="img/clogos/logo-dukleyhotels.jpg"></a>
					</div>
				</div>
